...
All parts are printed from **PC plastic** using an **FDM 3D printer**. Alternative plastics can be used, but they must withstand high temperatures. There are two different options for electronics assembly mounting:
