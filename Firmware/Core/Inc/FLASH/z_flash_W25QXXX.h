 ...
 ***************************************************/
/* active information */
// here values for the W25Q16JV/DL chips
#define EXT_FLASH_PAGE_SIZE     0x0100      // 256 bytes page size
#define EXT_FLASH_SECTOR_SIZE   0x1000      // 4KB sector size
#define EXT_FLASH_BLOCK_SIZE    0x00010000  // 64KB block size
#define EXT_FLASH_SIZE          0x00200000  // 2MB total size
#define EXT_FLASH_PAGE_NUM      0x2000      // 8192 pages
#define EXT_FLASH_SECTOR_NUM    0x0200      // 512 sectors
#define EXT_FLASH_BLOCK_NUM     0x0020      // 32 blocks
